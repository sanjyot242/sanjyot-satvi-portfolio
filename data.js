export const data = [
  {
    ...
    description:
      'Developed a comprehensive Full-Stack E-Commerce Platform using the MERN stack, showcasing complete development proficiency. Enhanced user experience with advanced state management through Redux Toolkit, React Router, and modern React features for a seamless, responsive design. Integrated Razorpay for secure payments and implemented webhooks for real-time transaction verification. Optimized data management with MongoDB Atlas and efficient data fetching using Tanstack Query.',
    link: 'www.google.com',
