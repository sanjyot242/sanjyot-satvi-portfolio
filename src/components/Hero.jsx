export default function Hero() {
  return (
    <>
      <section className='bg-neutral-950 flex flex-col md:flex-row items-center justify-between w-full h-full  px-8 gap-2 md:gap-16 space-y-4  mb-20'>
        ...
        <div className='md:w-1/2 flex justify-center  mb-8 md:mb-0'>
          <div className='mt-10 md:mt-0 w-[380px] h-[400px] md:w-80 md:h-[400px] lg:w-96 lg:h-[400px] overflow-hidden rounded-md shadow-lg'>
            <img
